...
public class MichaelBentoncit130_hw5
{
	public static void main(String[] a)
	{
		...
		if(password.equals("java"))
		{
			...
			if(email.contains("@"))
			{
				System.out.print("Enter your office mail code: ");
				mailCode = get.nextLine().charAt(0);

				randNum = (Math.random() * highNum - lowNum +1) + lowNum;

				// Display business card
				System.out.println("Here is your official business card:");
				System.out.println("*--------------------------------------" +
								"---------------------*");
				...
				System.out.printf("| Your assigned random number is: %4.2f", randNum);
